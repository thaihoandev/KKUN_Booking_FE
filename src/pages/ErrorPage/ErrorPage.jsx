...
function ErrorPage({ error, message }) {
    return (
        <>
            <div
                class="error-section"
                style={{
                    backgroundImage: `url(${process.env.PUBLIC_URL}/assets/img/background/error-bg.png)`,
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-6">
                            <div class="error-wrapper">
                                ...
                                <p>{message}</p>
                                <p>
                                    Chúng tôi tin vào việc cung cấp các giải
                                    pháp phù hợp được thiết kế để giải quyết các
                                    yêu cầu riêng biệt của bạn. Chúng tôi dành
                                    thời gian để hiểu.
                                </p>
                                <Link class="primary-btn1 hover-btn3" to={`/`}>
                                    <svg
