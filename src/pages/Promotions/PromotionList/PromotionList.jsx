...
function PromotionList() {
    const [vouchers, setVouchers] = useState([
        ...
        {
            id: 1,
            imageUrl: "https://cdn0.agoda.net/images/emailmarketing/contentcard/upto5_mspa.png",
        ...
        {
            id: 2,
            imageUrl: "https://cdn0.agoda.net/images/emailmarketing/contentcard/upto8_mspa.png",
        ...
        {
            id: 3,
            imageUrl: "https://cdn0.agoda.net/images/emailmarketing/contentcard/Web_Deals_Page_More_Deals.png",
                                ...
                                <div className="transport-type">
                                    <div className="row">
                                        ...
                                        {voucher.conditions.map((condition, index) => (
                                            <h6 key={index}>- {condition}</h6>
                                        ))}
                                        {/* Thời hạn còn lại của voucher */}
                                        <h6>{calculateTimeLeft(voucher.expiryDate)}</h6>
                                        {/* Mã khuyến mại */}
                                        <h6>Mã khuyến mại: {voucher.promoCode}</h6>
                                    </div>
                                </div>
                    ...
                    <div className="transport-card px-2 text-center">
                        ...
                        <div className="row my-2 ">
                            ...
                            <div className="col-md-4">
                                <h6 >
                                    Tìm và thu thập phiếu giảm giá. Nếu có mã khuyến mại thì đừng quên sao chép nó!
                                </h6>
                            </div>
                            <div className="col-md-4">
                                <h6>
                                    Tìm chỗ nghỉ có nhãn "Được áp dụng phiếu giảm giá" để sử dụng phiếu giảm giá
                                </h6>
                            </div>
                            <div className="col-md-4">
                                <h6>
                                    Đảm bảo áp dụng phiếu giảm giá / mã khuyến mại của quý khách trước khi hoàn tất thanh toán.
                                </h6>
                            </div>
