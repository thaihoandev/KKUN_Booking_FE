...
function AllHotelList() {
    return (
        <>
            {/* =========== ADmin xem danh sách tất cả khách sạn ============================= */}
                            ...
                            <table class="eg-table2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td data-label="Tour Package">
                                            <div class="product-name">
                                                <div class="img">
                                                    <img src="assets/img/innerpage/room-img-02.jpg" alt="" />
                                                </div>
                                                <div class="product-content">
                                                    <h6><a href="./pages/Hotel/Hotel_details.jsx">Hotel Windy Terrace</a></h6>
                                                    <p>
                                        ...
                                        <td data-label="Status">
                                            <span class="confirmed"> Booked</span> {/* Trạng thái đặt phòng  */}
                                        </td>
                                        <td data-label="Execution Time">
                                            20 Thg 10, 2024 - 22 Thg 10, 2024
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Status">
                                            <span class="pending"> Pending</span> {/* Trạng thái đặt phòng  */}
                                        </td>
                                        <td data-label="Execution Time">
                                            20 Thg 10, 2024 - 22 Thg 10, 2024
                                        </td>
                                    ...
                                    <tr>
                                        <td data-label="Tour Package">
                                            <div class="product-name">
                                                ...
                                                <div class="product-content">
                                                    <h6><a href="#">Tranquil Twilight Lodge</a></h6>
                                                    <p>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                                                            <path d="M8.99939 0C5.40484 0 2.48047 2.92437 2.48047 6.51888C2.48047 10.9798 8.31426 17.5287 8.56264 17.8053C8.79594 18.0651 9.20326 18.0646 9.43613 17.8053C9.68451 17.5287 15.5183 10.9798 15.5183 6.51888C15.5182 2.92437 12.5939 0 8.99939 0ZM8.99939 9.79871C7.19088 9.79871 5.71959 8.32739 5.71959 6.51888C5.71959 4.71037 7.19091 3.23909 8.99939 3.23909C10.8079 3.23909 12.2791 4.71041 12.2791 6.51892C12.2791 8.32743 10.8079 9.79871 8.99939 9.79871Z"></path>
                                                        </svg> <span>Dhaka, Bangladesh</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td data-label="Status">
                                            <span class="rejected"> Cancelled</span> {/* Trạng thái đặt phòng  */}
                                        </td>
                                        <td data-label="Execution Time">
                                            20 Thg 10, 2024 - 22 Thg 10, 2024
                                        </td>
