                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-center mb-40">
                                ...
                                <h2>
                                    {" "}
                                    {t("homepage.desiredVacationDestination")}
                                </h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 d-flex flex-column align-items-center justify-content-between flex-wrap gap-4 mb-60">
                            <div class="section-title text-center">
                                ...
                                <h2> {t("homepage.personalSuitability")}</h2>
                            </div>
                            <ul
                                class="nav nav-tabs"
                                id="facilitesTab"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-center mb-40">
                                ...
                                <h2>
                                    {" "}
                                    {t("homepage.popularTravelExperiences")}
                                </h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title text-center mb-60">
                                ...
                                <h2>
                                    {" "}
                                    {t("homepage.vietnamMostOutstandingHotels")}
                                </h2>
                            </div>
                        </div>
                    </div>
